            ...
            if (trafficKey <= cumulativePercentage)
              {
                ...
                if (m_trafficPatterns[patternId].m_excludeBefore != "" &&
                    m_trafficPatterns[patternId].m_excludeAfter != "")
                  {
                    ...
                    std::cout << "Interest exclude: "
                              << m_trafficPatterns[patternId].m_excludeBefore
                              << ", " << m_trafficPatterns[patternId].m_excludeAfter << std::endl;
                ...
                std::cout << "Interest size: " << interest.wireEncode().size() << std::endl;
